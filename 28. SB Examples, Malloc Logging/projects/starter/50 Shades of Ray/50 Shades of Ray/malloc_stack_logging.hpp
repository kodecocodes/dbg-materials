...
//*****************************************************************************/
#pragma mark - Appended from stack_logging.h.auto.html
//*****************************************************************************/
...
extern "C" boolean_t turn_on_stack_logging(stack_logging_mode_type mode);

extern "C" void turn_off_stack_logging();

extern "C" kern_return_t __mach_stack_logging_start_reading(task_t task, vm_address_t shared_memory_address, boolean_t *uses_lite_mode);
extern "C" kern_return_t __mach_stack_logging_stop_reading(task_t task);
